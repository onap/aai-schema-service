...
public class GenerateSwaggerTest {
    ...
    // Helper method to mock SchemaVersion
    private SchemaVersion mockSchemaVersion() {
        // Create a mock of SchemaVersion
        SchemaVersion mockVersion = mock(SchemaVersion.class);

        // Ensure the toString method is mocked to return the expected version
