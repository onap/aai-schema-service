...
class AAIConfigTranslatorTest {
    ...
    void testNoFilesInDirectory() {
        ...
        // Simulate File object creation for directory
        File rootDirectory = mock(File.class);
        when(rootDirectory.listFiles()).thenReturn(new File[]{mockVersionDirectory});
        when(mockVersionDirectory.getName()).thenReturn("v1");
