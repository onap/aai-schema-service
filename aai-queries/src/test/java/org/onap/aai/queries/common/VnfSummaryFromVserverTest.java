...
public class VnfSummaryFromVserverTest extends QueryTest {
	public VnfSummaryFromVserverTest() throws AAIException, NoEdgeRuleFoundException {
		super();
	}
	...
	protected void createGraph() throws AAIException, NoEdgeRuleFoundException {
		...
		rules.addEdge(g, vserver, genericvnf1);
	...
	protected String getQueryName() {
		return "vnf-summary-fromVserver";
	}
	@Override
	protected void addStartNode(GraphTraversal<Vertex, Vertex> g) {
		g.has("vserver-id","vserver-id-1");
	}
