...
public class GetComponentList1Test extends QueryTest {
	public GetComponentList1Test() throws AAIException, NoEdgeRuleFoundException {
		super();
	}
    ...
    protected void createGraph() throws AAIException, NoEdgeRuleFoundException {
		...
		Vertex volume2 = graph.addVertex(T.label, "volume-group", T.id, "14", "aai-node-type", "volume-group", "volume-group-id", "volume-group-id-2", "volume-group-name", "volume-group-name2");

		Vertex serviceinstance1 = graph.addVertex(T.label, "service-instance", T.id, "7", "aai-node-type", "service-instance", "service-instance-id", "serviceinstanceid1");
		Vertex l3network1 = graph.addVertex(T.label, "l3-network", T.id, "8", "aai-node-type", "l3-network", "network-id", "networkid1");
		Vertex genericvnf1 = graph.addVertex(T.label, "generic-vnf", T.id, "9", "aai-node-type", "generic-vnf", "vnf-id", "vnfid1");
		Vertex vserver1 = graph.addVertex(T.label, "vserver", T.id, "10", "aai-node-type", "vserver", "vserver-id", "vserverid1");
		Vertex volume1 = graph.addVertex(T.label, "volume-group", T.id, "11", "aai-node-type", "volume-group", "volume-group-id", "volume-group-id-1", "volume-group-name", "volume-group-name1");
		Vertex vfmodule1 = graph.addVertex(T.label, "vf-module", T.id, "12", "aai-node-type", "vf-module", "vf-module-name", "vf-module-name1");
		...
		rules.addEdge(g, vfmodule, volume2);

        rules.addEdge(g, serviceinstance1, l3network1);
		rules.addEdge(g, serviceinstance1, genericvnf1);
		rules.addEdge(g, genericvnf1, volume1);
		rules.addTreeEdge(g, genericvnf1, vfmodule1);
		rules.addEdge(g, vfmodule1, l3network1 );
        rules.addEdge(g, vfmodule1, vserver1);
		rules.addEdge(g, vfmodule1, volume1);
		...
		expectedResult.add(volume2);

    }

	@Override
	protected String getQueryName() {
		return	"getComponentList1";
	}
	@Override
