...
public class GetComponentList2Test extends QueryTest {


	public GetComponentList2Test() throws AAIException, NoEdgeRuleFoundException {
		super();
	}
	...
	protected void createGraph() throws AAIException, NoEdgeRuleFoundException {
		...
		Vertex config = graph.addVertex(T.label, "configuration", T.id, "15", "aai-node-type", "configuration", "configuration-id", "configuration0");
		...
		rules.addEdge(g, serviceinstance, config);
