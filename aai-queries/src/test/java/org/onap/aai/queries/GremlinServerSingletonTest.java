...
public class GremlinServerSingletonTest {
    ...
    public void testGetStoredQueryFromConfig_QueryDoesNotExist() {
        // Set up the scenario where no query is found for the key
        when(mockQueryConfig.getStoredQuery("invalidKey")).thenReturn(null);

        // Call the method with an invalid key
        String query = gremlinServerSingleton.getStoredQueryFromConfig("invalidKey");
    ...
    public void testGetCustomQueryConfig_QueryDoesNotExist() {
        ...
        // Call the method with an invalid key
        CustomQueryConfig result = gremlinServerSingleton.getCustomQueryConfig("invalidKey");
