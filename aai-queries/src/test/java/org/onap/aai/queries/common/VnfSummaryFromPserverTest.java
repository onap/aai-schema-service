...
public class VnfSummaryFromPserverTest extends QueryTest {
	public VnfSummaryFromPserverTest() throws AAIException, NoEdgeRuleFoundException {
		super();
	}
	...
	protected void createGraph() throws AAIException, NoEdgeRuleFoundException {
		...
		Vertex genericvnf3 = graph.addVertex(T.label, "generic-vnf", T.id, "17", "aai-node-type", "generic-vnf", "vnf-id", "vnfId3", "vnf-name", "vnf-name-3", "vnf-type", "vnfType3");
		Vertex genericvnf4 = graph.addVertex(T.label, "generic-vnf", T.id, "18", "aai-node-type", "generic-vnf", "vnf-id", "vnfId4", "vnf-name", "vnf-name-4", "vnf-type", "vnfType4");
		...
		Vertex vserver = graph.addVertex(T.label, "vserver", T.id, "15", "aai-node-type", "vserver", "vserver-id", "vserver-id-1");
		Vertex vserver2 = graph.addVertex(T.label, "vserver", T.id, "16", "aai-node-type", "vserver", "vserver-id", "vserver-id-2");

		GraphTraversalSource g = graph.traversal();

		rules.addEdge(g, pserver, genericvnf1);
		rules.addEdge(g, pserver, vserver);
		rules.addEdge(g, vserver, genericvnf2);
		rules.addEdge(g, genericvnf2, platform);
		rules.addEdge(g, genericvnf2, lineofbus);
		rules.addEdge(g, genericvnf2, serviceinst);
		rules.addEdge(g, serviceinst, owningent);
		rules.addEdge(g, serviceinst, project);

		rules.addEdge(g, pserver2, genericvnf3);//false
		rules.addEdge(g, pserver2, vserver2);//false
		rules.addEdge(g, pserver2, genericvnf4);//false
		rules.addEdge(g, genericvnf4, platform2);//false
		rules.addEdge(g, genericvnf4, lineofbus2);//false
		rules.addEdge(g, genericvnf4, serviceinst2);//false
		rules.addEdge(g, serviceinst2, owningent2);//false
		rules.addEdge(g, serviceinst2, project2);//false

		expectedResult.add(genericvnf1);
		expectedResult.add(genericvnf2);
	...
	protected String getQueryName() {
		return "vnf-summary-fromPserver";
	}
	@Override
